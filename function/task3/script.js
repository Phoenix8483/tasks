...
function t3() {
    let checkbox3 = document.querySelector('.ch-3')
...
function t4() {
    const selectedValue = document.querySelector('input[class="r-4"]:checked').value;
    return selectedValue; // Выведет значение выбранной радиокнопки
}
...
function t5() {
    const selectedNumber1 = +document.querySelector('.s51').value
    const selectedSymbol = document.querySelector('.s52').value
    const selectedNumber2 = +document.querySelector('.s53').value

    let result = eval(selectedNumber1 + selectedSymbol + selectedNumber2)
    return result
...
function t6(num1, num2, sign) {
    ...
    const result = eval(num1 + sign + num2)
    return result
}
...
function t8(num, method) {
    ...
    if (method === 'ceil') return Math.ceil(num)
}
...
document.querySelector('.b-9').addEventListener('click', function () {
    document.querySelector('.out-9').textContent = t9(2, 2);
})
...
document.querySelector('.b-11').addEventListener('click', function () {
    document.querySelector('.out-11').textContent = t11(33, 22);
})
...
function t17() {
    const valueSelect = document.querySelector('.s-171').value
    return valueSelect
}
...
function t18() {
    let valueInput = document.querySelector('.i-18').value
    return valueInput
}
...
function t19() {
    let valueInput = document.querySelector('.i-19').value
    return valueInput
}
...
function t21(s) {
    ...
    let tempNumber = t13(10, 20)

    if (s === 'even') {
        if (tempNumber % 2 === 0) return tempNumber
        else return tempNumber + 1
    }
...
function t25(arr) {
    if (arr.every((index) => !isNaN(index))) return true
    else return false

}

document.querySelector('.b-25').addEventListener('click', function () {
    document.querySelector('.out-25').textContent = t25([25, 100]);
})
...
function t26() {
    let userName = document.querySelector('.i-26').value.toLowerCase()
    if (userName.length !== 0) {
        document.querySelector('.out-26').textContent = userName
    } else return
...
document.querySelector('.b-28').addEventListener('click', function () {
    document.querySelector('.out-28').textContent = t28('hello my world', 'my');
})
