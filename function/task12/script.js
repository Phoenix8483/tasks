...
function generatePassword(arr) {
    ...
    return function showRandomElement() {
...
function generatePassword2(arr, n) {
    ...
    return function showPassword() {
        let pass = ''
        for (let i = 0; i < n; i++) {
            pass = pass + arr[randomInteger(0, arr.length - 1)]
        }
        return pass
    }
}

let password2 = generatePassword2(['b', 'y', 'Y', 'b', 'z', 'L', 'S', 'q', 'W'], 8);
