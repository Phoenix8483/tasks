...
const ar1 = [4, 5, 6];
let res1;
let callBack1 = (element) => element ** 3
...
let res5 = [];
let callBack5 = (element) => {
    res5.push(element.toLowerCase())
}
...
let res8;
res8 = ar7.every((element) => element > 10);// сюда в скобки дописываете стрелочную функцию
...
let res9;
let callBack9 = (element) => typeof element === 'boolean'
...
let res10;
res10 = ar9.some((element) => typeof element === 'boolean');// сюда в скобки дописываете стрелочную функцию
