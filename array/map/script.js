...
const f4 = () => {
    a4_res = a4.map(item => item > 0 ? item : 0)
    console.log(a4)
    console.log(a4_res)
}
...
const f8 = () => {
    a8_res = a8.map((item) => {
        let sum = 0
        const sumArray = item.map(elem => sum += elem)
        return sum
    })
    console.log(a8)
    console.log(a8_res)
...
document.querySelector('.b-10').addEventListener('click', () => {
    console.log(f10(a10, a10_res, callback10));
});