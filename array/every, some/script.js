...
const f1 = () => {
    const result = a1.every(item => item > a1_from && item < a1_to)
...
const f2 = () => {
    const result = a2.every(item => item > a2_from && item < a2_to)
...
const f4 = () => {
    ...
    const result = a4.every(item => item.includes(100))
...
let a5 = [
    ...
    { "name": "Tomiko", "age": 18, "pay": false },
    { "name": "Utano", "age": 56, "pay": true }
];

const f5 = () => {
    const result = a5.every(item => item.age >= 16)
...
const f6 = () => {
    const newArr = a6.filter(item => item > a6_from)
    const result = a6.length === newArr.length
...
const f8 = () => {
    const result = a8.some(item => item > 100)
...
const f9 = () => {
    const result = a9.some(item => item.age <= 16)
...
const f10 = () => {
    const result = a10.some(isBigFrom)
