...
const f4 = () => {
    ...
    for (let key in a4) {
        ...
        if (a4[key].includes(input)) {
            index = index + ' ' + a4[key].indexOf(input)
        }
...
const f5 = () => {
    let input = +document.querySelector('.i-5-1').value
    let index = +document.querySelector('.i-5-2').value
    let out = document.querySelector('.out-5')

    out.textContent = a5.includes(input, index)
...
const f6 = () => {
    const inputUser = document.querySelector('.i-6').value
    const out = document.querySelector('.out-6')
    const str = a6.join()

    out.textContent = str.includes(inputUser)
}
...
const f8 = () => {
    const inputUser = document.querySelector('.i-8').value
    const out = document.querySelector('.out-8')


    out.textContent = a8.includes(inputUser)
}
...
const f9 = () => {
    const inputUser = document.querySelector('.i-9').value.toLowerCase()
    const out = document.querySelector('.out-9')
    const a9Clear = a9.join(' ').toLowerCase()

    out.textContent = a9Clear.includes(inputUser)
