...
const f5 = () => {
    let result = a5.reduce((accum, item) => accum += item, 0)
...
const f6 = () => {
    let result = a6.reduce((accum, item) => accum = accum * item)
...
const f7 = () => {
    let result = a7.reduce((accum, item) => {
        if (item > 0) {
            return accum += item
        }
        return accum
...
const f8 = () => {
    let result = a8.reduce((accum, item) => {
        if (item > 0) {
            return accum += item
        }
        return accum
...
const f9 = () => {
    let result = a9.reduce((accum, item) => {
        if (item > 0) {
...
const f10 = () => {
    ...
    document.querySelector('.out-10').innerHTML = arr
...
const f13 = () => {
    let res = a13.reduce((accum, item) => {
        if (item.length > a13[accum].length) {
            return item.length
        }
        return accum
    }, 0)
