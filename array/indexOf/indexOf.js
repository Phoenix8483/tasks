...
const f1 = () => {
    let userInput = +document.querySelector('.i-1').value
    const searchElement = a1.indexOf(userInput)
    document.querySelector('.out-1').textContent = searchElement
}
...
const f2 = () => {
    let userInput = +document.querySelector('.i-2').value
    const searchElement = a2.indexOf(userInput)
    if (searchElement !== -1) {
        document.querySelector('.out-2').textContent = searchElement
    } else {
...
const f3 = () => {
    let userInput = +document.querySelector('.i-3').value
    const searchElement = a3.indexOf(userInput)
    let outElement = document.querySelector('.out-3')
    if (searchElement === -1) {
        outElement.textContent = false
    } else {
        outElement.textContent = true
    }
...
const f4 = (arr, elem) => {
    ...
    const searchElement = arr.indexOf(elem)
    let outElement = document.querySelector('.out-4')
    outElement.textContent = searchElement
}
...
const f5 = () => {
    elem = +document.querySelector('.i-5-1').value
    index = +document.querySelector('.i-5-2').value
    const searchElement = a5.indexOf(elem, index)
    document.querySelector('.out-5').textContent = searchElement
}
...
const f6 = () => {
    ...
    const arr6 = a6.split('')
    // console.log(arr6);
    const searchElem = arr6.indexOf(elem)
    document.querySelector('.out-6').textContent = searchElem
...
const f7 = (arr, elem) => {
    ...
    document.querySelector('.out-7').textContent = searchElem
}

document.querySelector('.b-7').addEventListener('click', () => {
    f7(a7, +document.querySelector('.i-7').value)
})
// TASK 08 * - сложная
...
const f8 = () => {
    ...
    let index = a8.indexOf(input)

    while (index !== -1) {
        res08.push(index)
        index = a8.indexOf(input, index + 1)
    }
